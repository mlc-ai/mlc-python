...
template <typename... Args> struct IsAnyImpl : std::false_type {};
template <typename Arg> struct IsAnyImpl<Arg> : std::is_base_of<MLCAny, RemoveCR<Arg>> {};
template <typename... Args> constexpr bool IsAny = IsAnyImpl<Args...>::value;
